...
class Prompt:
    ...
    def generate(self,detail:dict):
        self.prompt=f"{detail} these are the details of a mail, now give me the summary and ask minimum questions for drafting a reply for this mail(return json like 'q1':'ques...')"
